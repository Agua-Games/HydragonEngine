...
| [mdl_authoring.md](mdl_authoring.md) | writing an MDL the RTX compiler accepts: how an extension registers its own modules, the three dialect rules that bite, the constructs to copy, and what a failed compile looks like |
