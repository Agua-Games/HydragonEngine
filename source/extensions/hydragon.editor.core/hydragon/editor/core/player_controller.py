        ...
        try:
            ...
            def _on_hit(hit):
                ...
                if hit_rb == rb_path or hit_col == rb_path:
                    return True
                # A game volume is not ground: without this, a ball airborne inside a volume whose
                # floor is within reach of the ray reports as grounded and can jump again mid-air.
