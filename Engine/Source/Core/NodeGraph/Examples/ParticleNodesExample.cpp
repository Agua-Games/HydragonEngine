 ...
 * 
 *  - Particle system setup with emitters, forces, and modifiers
 */
#if 0
...
auto particles = graph.create<ParticleSystemNode>("fire")
    ...
    .connect<ParticleEmitter>("emitter")
        .rate(50.0f)
