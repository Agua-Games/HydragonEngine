...
auto squadSystem = Scene::current()
    .add<CombatManager>("squadCombat")
    .connect<SquadMechanics>("squadCoordination")
        .connect<Squad>("squadFormation")
            .formationType(FormationType::Wedge)
            .formationSpacing(2.0f)
            .connect<SquadMember>("pointMan")
                .role(SquadRole::Leader)
                .connect<RadioMechanics>("squadComms")
                .connect<RadioChannel>("squadNet")
                    .frequencyName("squadNet")
                    .encryption(true)
        ...
        .connect<TacticalAI>("squadTactics")
            ...
            .flanking(true)
            .connect<SecurityMechanics>("threatEval")
                .threatLevel(ThreatLevel::High)
                .threatLevelThreshold(0.8f);
