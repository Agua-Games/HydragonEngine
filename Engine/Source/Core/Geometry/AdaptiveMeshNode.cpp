 ...
 */
void AdaptiveMeshNode::setupComputeResources() {
 ...
 */
void AdaptiveMeshNode::createPredictionPipeline() {
    auto& vk = VulkanCore::get();
 ...
 */
glm::vec3 AdaptiveMeshNode::predictDeltaFromPattern(
 ...
 */
float AdaptiveMeshNode::evaluatePatternSimilarity(
...
bool AdaptiveMeshNode::shouldApplyPrediction(uint32_t level, const CompressionConfig& config) {
    return config.proceduralPrediction.enabled && 
           level >= config.proceduralPrediction.activationLevel;
}

// === Processing ===
void AdaptiveMeshNode::blendPredictedDeltas(uint32_t level) {
 ...
 */
void AdaptiveMeshNode::dispatchComputePrediction(VkCommandBuffer cmd, 
 ...
 */
void AdaptiveMeshNode::processGPUPrediction(uint32_t level) {
    auto& vk = VulkanCore::get();
 ...
 */
void AdaptiveMeshNode::optimizeDeltaStorage(const CompressionConfig& config) {
...
void AdaptiveMeshNode::packDeltaProgressive(VertexDelta& delta) {
...
void AdaptiveMeshNode::packDeltaBalanced(VertexDelta& delta) {
...
void AdaptiveMeshNode::packDeltaExtended(VertexDelta& delta) {
...
void AdaptiveMeshNode::packDeltaPacked(VertexDelta& delta) {
...
void AdaptiveMeshNode::processAdaptiveMesh(const MeshData& mesh, const CompressionConfig& config) {
...
void AdaptiveMeshNode::processNode() {
