 ...
 * 
 * @file MaterialAtlasNode.h
 * @brief MaterialAtlasNode represents a material atlas node in the engine's node graph.
 * 
 * ARCHITECTURAL NOTES:
...
class MaterialAtlasNode : public Node {
public:
    ...
    explicit MaterialAtlasNode(const MaterialAtlasInfo& info = MaterialAtlasInfo())
